...
export default function StudioPage() {
  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6 animate-fade-in">
      {/* Studio Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-2">
        <div>
          <div className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-wider">
            <Sparkles className="w-4 h-4" /> Multi-Channel Content Studio
          </div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mt-1">
            30-Day Campaign Workspace
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Manage, schedule, copy, and publish daily content across LinkedIn, Facebook, Instagram, TikTok, and Email.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/wizard"
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-200 transition-colors"
          >
